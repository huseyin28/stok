...
<html>
  <head> 
   ...
   <link rel="stylesheet" href="../dist/css/style.sea.css"d id="theme-stylesheet">
    <link rel="stylesheet" href="../dist/css/custom.css">
   <link rel="shortcut icon" href="../dist/img/logo_black.png">
    <!--[if lt IE 9]>
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <!-- Megamenu end     -->
            <!-- Log out -->
            <div class="list-inline-item logout"><a id="logout" href="login.html" class="nav-link">Çıkış <i class="icon-logout"></i></a></div>
            <!-- Log out end -->
          </div>
        </div>
      </nav>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
          <div class="avatar"><img src="../dist/img/avatar-6.jpg" alt="..." class="img-fluid rounded-circle"></div>
          <div class="title">
